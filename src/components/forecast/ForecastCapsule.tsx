...
import { convertDateTo12HrFormat, getDayOfWeek } from "@/lib/DateHelper";
...
export default function ForecastCapsule({ forecast, width, height, radius }: ForecastCapsuleProps) {
